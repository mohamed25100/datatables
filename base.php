...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="https://datatables.net/media/css/site.css?_=09336a954ebb1a7edfe2e2aaf653ebbd1">
		<!--[if lte IE 9]>
...
div.fw-container {
	z-index: 1;
		...
		<script src="https://datatables.net/media/js/site.js?_=0c2fbf9886ac7879bde5ccbf9389fa9a"></script>
		<script src="https://media.ethicalads.io/media/client/ethicalads.min.js"></script>
		<script src="https://datatables.net/media/js/dynamic.php" async></script>
...
<div class="cdn">
    <span>CSS</span>
    <input type="text" value="//cdn.datatables.net/1.12.1/css/jquery.dataTables.min.css" readonly>
</div>

<div class="cdn">
    <span>JS</span>
    <input type="text" value="//cdn.datatables.net/1.12.1/js/jquery.dataTables.min.js" readonly>
</div>
		...
		<div class="fw-body">
			<div class="content">
				...
				<div class="news">
						...
						<a href="https://www.gyrocode.com/articles/jquery-datatables-card-view/">
							<h4>Card View</h4>
							<h5>19th Feb 2020</h5>
							<p>Michael has been at it again (creating useful blog posts about DataTables!). This time discussing a technique originally suggested in the forum for using DataTables with a card view.</p>
						</a>
					</div>					<div class="news-item external">
						<a href="">
		...
		<div class="fw-footer">
			...
			<div class="copyright">
				...
				<p>
					...
					&copy; 2007-2022 <a href="/license/mit">MIT licensed</a>. <a href="/privacy">Privacy policy</a>. <a href="/supporters">Supporters</a>.<br>
